  ...
  document.getElementById("page-agenda").innerHTML = `
    <div class="page-header">
      ...
      <div style="display:flex;gap:8px;align-items:center">
        <button class="btn btn-ghost" onclick="agendaMonth--;if(agendaMonth<0){agendaMonth=11;agendaYear--;}renderAgenda()">← PRÉCÉDENT</button>
        ...
        <button class="btn btn-ghost" onclick="agendaMonth++;if(agendaMonth>11){agendaMonth=0;agendaYear++;}renderAgenda()">SUIVANT →</button>
